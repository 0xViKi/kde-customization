# Generated by Powerlevel10k configuration wizard on 2021-06-01 at 00:10 IST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 32822.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 12h time, angled separators, sharp heads, slanted tails, 2 lines, dotted, full frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND='#E59E6D'
 ...
 # Current directory background color.
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=29
 ...
 # Context color when running with privileges.
  ...
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=48
  ...
  # typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%n@%m' --> Original Template
  ...
  typeset -g POWERLEVEL9K_TIME_FOREGROUND='#f535aa'
